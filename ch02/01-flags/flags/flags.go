...
// Config struct will be the holder for our flags
type Config struct {
	subject      string
	isAwesome    bool
	howAwesome   int
...
// Setup method initializes a config from flags that are passed in
func (c *Config) Setup() {
	...
	flag.BoolVar(&c.isAwesome, "isawesome", true, "is it awesome or what?")
...
// GetMessage method uses all of the internal config vars and returns a sentence
