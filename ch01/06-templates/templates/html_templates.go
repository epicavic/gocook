...
func HTMLDifferences() error {
	...
	fmt.Println(template.JSEscaper(`JSEscaper example: <example@example.com>`))
	fmt.Println(template.HTMLEscaper(`HTMLEscaper example: <example@example.com>`))
	fmt.Println(template.URLQueryEscaper(`URLQueryEscaper example: <example@example.com>`))
